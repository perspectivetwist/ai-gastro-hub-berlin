...
export default function AnnouncementBanner() {
  ...
  if (pathname === "/berlin-ki-studie-2026") return null;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>
          <span className="font-semibold">91% der Berliner Restaurants unsichtbar für KI.</span>{" "}
          Studie lesen
        </span>
        <span
